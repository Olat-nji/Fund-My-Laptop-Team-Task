                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <span><b style="font-size: 22px;"> {{date("M ,Y",strtotime($invests->request->repayment->last()->last_payment_date))}} </b></span> {{date("M ,Y",strtotime($invests->request->repayment->last()->last_payment_date))  }}</td>
                                    <td>
